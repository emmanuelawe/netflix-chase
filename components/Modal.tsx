...
import { FiThumbsUp, FiVolume2, FiVolumeX } from 'react-icons/fi'
...
const Modal = () => {
  ...
  return (
    <MuiModal open={showModal} onClose={handleClose} className='fixed !top-7
    left-0 right-0 z050 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll scrollbar-hide rounded-md'>
        <>
        <button onClick={handleClose} className="modalButton absolute right-5
        h-9 w-9 border-none bg-[#181818] top-5 !z-40 hover:bg-[#181818]">
